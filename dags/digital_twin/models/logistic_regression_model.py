...
from digital_twin.configs.models_conf import LogisticRegressionConf
...
class LogisticRegressionModel(BaseModel):
    ...
    def _load_config() -> Dict[str, Any]:
        """ Load configuration from models_conf.LogisticRegressionConf class """
        return LogisticRegressionConf.model_params
    ...
    def create_new_model(self):
        """ Create new LogisticRegression instance """
    ...
    def train(self, x_train: pd.DataFrame, y_train: pd.Series,
        ...
        self.model.fit(x_train, y_train.values.ravel(), sample_weight=sample_weight)
    ...
    def predict_proba(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        return pd.DataFrame(predictions, index=original_index, columns=self.model.classes_)
